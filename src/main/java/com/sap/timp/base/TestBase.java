...
public class TestBase {
	...
	public WebDriver initialization() {
		 ...
		 * ); driver = new ChromeDriver(options); options.addArguments("--headless");
		 * options.addArguments("start-maximized"); // open Browser in maximized mode
		 * options.addArguments("disable-infobars"); // disabling infobars
		 * options.addArguments("--disable-extensions"); // disabling extensions
		 * options.addArguments("--disable-gpu"); // applicable to windows os only
	...
	public void attributeToBeElement(String locator, String attribute, String value) {
		WebDriverWait wait = new WebDriverWait(driver, 360);
	...
	public void dobleClickElement(String locator) {
	...
	public void moveElementTo(WebElement element, WebElement hacia) {
		Actions actions = new Actions(driver);
	...
	public void moveElementTo(String desde, String hacia) {
		Actions actions = new Actions(driver);

		actions.dragAndDrop(findElement(desde), findElement(hacia)).perform();
